...
const confirmationEmail = (email, name, code) => {
  sgMail.send({
    ...
    html: confirmationCodeEmailHtml(name, code),
  });
};

function confirmationCodeEmailHtml(name, code) {
  return `
  <body>
  ...
  <![endif]-->
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 0px 0px; line-height:30px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h2 style="text-align: center"><span style="font-family: &quot;comic sans ms&quot;, cursive"><strong>קוד אימות</strong></span></h2><div></div></div></td>
      </tr>
    </tbody>
    ...
    <tbody>
      <tr>
        <td style="padding:0px 0px 0px 0px; line-height:0px; text-align:inherit;" height="100%" valign="top" bgcolor="" role="module-content"><div><h3 style="text-align: center; font-family: inherit">,שלום ${name}</h3>
<h3 style="text-align: center; font-family: inherit">${code} :קוד האימות שלך להמשך ההזמנה הינו</h3><div></div></div></td>
      </tr>
    </tbody>
  </table></td>
                                      </tr>
